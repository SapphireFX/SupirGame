...
import com.sapphirefx.supirgame.resources.FontSizePair;
...
public class CompositeComponents
{
    ...
    public ArrayList<ProtorypeLayerObject> layers = new ArrayList<ProtorypeLayerObject>();

    // TODO not nedeed
    public ArrayList<PrototypeSpineAnimation> sSpineAnimations = new ArrayList<PrototypeSpineAnimation>(1);
    ...
    public void update(CompositeComponents vo)
    {
        ...
        {
            layers.add(new ProtorypeLayerObject(vo.layers.get(i)));
        }
